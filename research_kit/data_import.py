...
def from_hl3(filepath, name=None, parent=None, keep_all=False, bin_which='zero', picobins=None, g2bins=None):
    ...
    offset = histx[np.argmax(np.correlate(hist0, hist1, mode='same'))] - (picotime.max()-picotime.min())/2
